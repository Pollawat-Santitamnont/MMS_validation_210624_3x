...
เมื่อเราคำนวณมาแล้วจะได้ผลลัพธ์ตามตารางนี้และไฟล์ผลลัพธ์ในรูปแบบ .pkl นอกจากนี้สามารถดูผลลัพธ์ที่ผมได้คัดลอกแยกตามความเร็วไว้ในไฟล์ .txt เช่น MMS_speed60_complete.txt 
